...
5. md5 占用主线程
6. ssr 和 csr 优缺点
7. SSR 水合过程带来的延迟以及如何解决
8. ISR
9. zustand 实现原理
10. jutai mobx 等状态管理库优缺点和使用场景
11. 多模态 ai 返回的数据格式处理
12. ai 上下文过长如何优化(让 ai 总结再变成上下文)
13. sse 传输一部分 json，如何流式解析，优化用户体验
14. 用户切换对话，如何处理当前聊天
15. react native hermers 架构
16. react native 旧架构中事件响应机制为什么慢
17. react native 问题排查，内存检测和优化

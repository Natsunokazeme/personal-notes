...
1. canvas 是一种通过 javascript 来绘制图形的技术,svg 是一种通过 xml 来绘制图形的技术
2. canvas 是一种位图技术,svg 是一种矢量技术
3. canvas 是一种通过像素来绘制图形的技术,svg 是一种通过路径来绘制图形的技术
...
1. 错误监控,通过 window.onerror 来监控页面的错误,可以通过 window.onerror 来捕获页面的错误,然后将错误信息发送到服务器
2. 错误上报,通过 ajax 来上报错误信息,可以通过 ajax 来将错误信息发送到服务器,然后在服务器端进行处理
3. 错误收集,通过 try catch 来收集错误信息,可以通过 try catch 来捕获代码块中的错误,然后将错误信息发送到服务器
